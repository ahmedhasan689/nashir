    ...
    <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
        ...
        <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
            ...
            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                ...
                <div class="menu-sub menu-sub-accordion menu-active-bg">
                    <div class="menu-item">
                        <a class="menu-link" href="{{ route('advertiser.index') }}">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
                            <span class="menu-title">Advertisers Lists</span>
                        </a>
                    </div>
                    ...
                    <div class="menu-item">
                        <a class="menu-link" href="{{ route('advertiser.create') }}">
                            ...
                            <span class="menu-title">Create Advertiser</span>
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="menu-sub menu-sub-accordion menu-active-bg">
                    <div class="menu-item">
                        <a class="menu-link" href="{{ route('publisher.index') }}">
                            ...
                            <span class="menu-title">Publishers Lists</span>
                        </a>
                    </div>
                    ...
                    <div class="menu-item">
                        <a class="menu-link" href="{{ route('publisher.create') }}">
                            ...
                            <span class="menu-title">Create Publisher</span>
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="menu-sub menu-sub-accordion menu-active-bg">
                    <div class="menu-item">
                        <a class="menu-link" href="{{ route('package.index') }}">
                            ...
                            <span class="menu-title">
                                {{ __('lang.packages_list') }}
                            </span>
                        </a>
                    </div>

                    <div class="menu-item">
                        <a class="menu-link" href="{{ route('package.create') }}">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
                            <span class="menu-title">
