                            ...
                            <div class="row">
                                <div class="col-xl-6 col-md-12 col-sm-12">
                                    <div class="mb-10">
                                        ...
                                        <input type="text" name="first_name" value="{{ $publisher->first_name }}" class="form-control form-control-solid @error('first_name') is-invalid @enderror" placeholder="Enter Name"/>
                                        @error('first_name')
                                ...
                                <div class="col-xl-6 col-md-12 col-sm-12">
                                    <div class="mb-10">
                                        ...
                                        <input type="text" name="last_name" value="{{ $publisher->last_name }}" class="form-control form-control-solid @error('last_name') is-invalid @enderror" placeholder="Enter Name"/>
                                        @error('last_name')
                                            <span class="text-danger">
                                                {{ $message }}
                                            </span>
                                ...
                                <div class="col-xl-6 col-md-12 col-sm-12">
                                    <div class="mb-10">
                                        ...
                                        <input type="email" name="email" value="{{ $publisher->email }}" class="form-control form-control-solid @error('email') is-invalid @enderror" placeholder="Example input"/>
                                        @error('email')
                                            <span class="text-danger">
                                                {{ $message }}
                                            </span>
                                ...
                                <div class="col-xl-6 col-md-12 col-sm-12">
                                    <div class="mb-10">
                                        ...
                                        <input type="text" name="phone_number" value="{{ $publisher->phone_number }}" class="form-control form-control-solid @error('phone_number') is-invalid @enderror" placeholder="Example input"/>
                                        @error('phone_number')
                                            <span class="text-danger">
                                                {{ $message }}
                                            </span>
                                    ...
                                    <div class="mb-10">
                                        ...
                                        <select class="form-select form-select-solid @error('package_id') is-invalid @enderror" aria-label="Select example" name="package_id">
                                            ...
                                            @foreach( $packages as $package )
                                                <option value="{{ $package->id }}" @if( $publisher->package ) @if( $package->id === $publisher->package->id ) selected @endif @endif>
