            ...
            <div id="kt_content_container" class="container">
                ...
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        <form action="{{ route('category_dashboard.update', ['id' => $category->id]) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-md-12 col-sm-12">
                                    <div class="mb-10">
                                        ...
                                        <input type="text" name="name" value="{{ $category->name }}" class="form-control form-control-solid @error('name') is-invalid @enderror" placeholder="Enter Name"/>
                                        @error('name')
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="mb-10">
                                        <div class="form-check form-check-custom form-check-solid form-check-sm">
                                            <input class="form-check-input" type="checkbox" value="1" name="status" id="flexRadioLg" @if( $category->status == '1') checked @endif/>
                                ...
                                <div class="col-6">
                                    <div class="mb-10">
                                        <img src="{{ $category->image }}" id="imageDisplay" alt="image" width="150" height="150">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
