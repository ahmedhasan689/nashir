                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-md-12 col-sm-12">
                                    <div class="mb-10">
                                        ...
                                        <input type="text" name="duration" value="{{ old('duration') }}" class="form-control form-control-solid @error('duration') is-invalid @enderror" placeholder="{{ __('lang.enter_duration') }}"/>
                                        @error('duration')
                                        <span class="text-danger">
                                                {{ $message }}
                                            </span>
