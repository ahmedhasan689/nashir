<x-dashboard-layout title="{{ __('lang.edit_blogs') }}" subTitle="{{ __('lang.edit') }}">
            ...
            <div id="kt_content_container" class="container">
                ...
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        <form action="{{ route('blog_dashboard.update', ['id' => $blog->id]) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-md-12 col-sm-12">
                                    <div class="mb-10">
                                        ...
                                        <input type="text" name="title_ar" value="{{ $blog->title_ar }}" class="form-control form-control-solid @error('title_ar') is-invalid @enderror" placeholder="Enter Name"/>
                                        @error('title_ar')
                                ...
                                <div class="col-xl-6 col-md-12 col-sm-12">
                                    <div class="mb-10">
                                        ...
                                        <input type="text" name="title_en" value="{{ $blog->title_en }}" class="form-control form-control-solid @error('title_en') is-invalid @enderror" placeholder="Example input"/>
                                        @error('title_en')
                                            <span class="text-danger">
                                                {{ $message }}
                                            </span>
                                ...
                                <div class="col-xl-6 col-md-12 col-sm-12">
                                    <div class="mb-10">
                                        ...
                                        <img src="{{ asset('storage') . '/' . $blog->cover_image }}" width="150" height="150" class="mt-4">
                                    </div>
    ...
    @push('js')
        ...
        <script>
            ClassicEditor
                ...
                .then(editor => {
                    ClassicEditor.setData({{ json_decode($blog->description_en) }})
                })
                .catch(error => {
                    console.error(error);
                });
            ...
            {{--ClassicEditor.instances['description_ar'].setData('Here');--}}
            {{--ClassicEditor.instances['description_en'].setData({{ $blog->description_en }});--}}
        </script>
    @endpush
</x-dashboard-layout>
