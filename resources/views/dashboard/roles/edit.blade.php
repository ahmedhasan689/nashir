<x-dashboard-layout title="{{ __('lang.edit_role') }}" subTitle="{{ __('lang.edit') }}">
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-md-12 col-sm-12">
                                    <div class="mb-10">
                                        ...
                                        <input type="text" name="name" value="{{ $role->name }}" class="form-control form-control-solid @error('name') is-invalid @enderror" placeholder=" {{ __('lang.role_name') }}"/>
                                        @error('name')
                                            ...
                                            <div class = "col-sm-3 my-2">
                                                <div class="form-check">
                                                    @if(in_array($permission->id, $rolePermissions))
                                                        <input class="form-check-input" type="checkbox" name = "permissions[]" value = "{{$permission->id}}" checked id = "{{$permission->id}}">
                                                    @else
                                                        <input class="form-check-input" type="checkbox" name = "permissions[]" value = "{{$permission->id}}" id = "{{$permission->id}}">
                                                    @endif
